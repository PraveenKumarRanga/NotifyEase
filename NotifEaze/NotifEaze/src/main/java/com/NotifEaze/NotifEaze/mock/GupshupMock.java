...
public class GupshupMock {
    ...
    public static String getSmsResponse(String messageId) {
        return SMS_MOCKED_RESPONSES.get(messageId);
    }

    
    public static String getEmailResponse(String emailId) {
        return EMAIL_MOCKED_RESPONSES.get(emailId);
    }
    
    public static String getSmsDeliveryStatusResponse(String messageId) {
        return SMS_DELIVERY_STATUS_MOCKED_RESPONSES.get(messageId);
    }

    
    public static String getPushNotificationResponse(String fcmToken) {
        return PN_MOCKED_RESPONSES.get(fcmToken);
    }
}
